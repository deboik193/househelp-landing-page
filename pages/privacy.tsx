    ...
    return (
      <section className="mx-10 sm:w-[855px] sm:mx-auto p-10 space-y-8 outline outline-1 outline-slate-400 mt-10">
        ...
        <ul>
          ...
          <li>
            <p><strong>Website</strong> refers to House Help, accessible from <a href="https://myhousehelp.ng/" rel="external nofollow noopener" target="_blank">https://myhousehelp.ng/</a></p>
          </li>
          <li>
            <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
          </li>
        </ul>
        <h1 className="text-2xl font-bold">Collecting and Using Your Personal Data</h1>
        ...
        <h1 className="text-2xl font-bold">Childrens Privacy</h1>
